...
public class WebSocketTests {
    ...
    public void validMove() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        //create pawn move
        Position startingPosition = (Position) TestFactory.getNewPosition(2, 5);
        Position endingPosition = (Position) TestFactory.getNewPosition(3, 5);
        ChessMove move = (ChessMove) TestFactory.getNewMove(startingPosition, endingPosition, null);
    ...
    public void invalidMoveBadMove() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        //try to move rook
        Position startingPosition = (Position) TestFactory.getNewPosition(1, 1);
        Position endingPosition = (Position) TestFactory.getNewPosition(1, 5);
        ChessMove move = (ChessMove) TestFactory.getNewMove(startingPosition, endingPosition, null);
    ...
    public void invalidMoveWrongTurn() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        //try to move pawn
        Position startingPosition = (Position) TestFactory.getNewPosition(7, 5);
        Position endingPosition = (Position) TestFactory.getNewPosition(5, 5);
        ChessMove move = (ChessMove) TestFactory.getNewMove(startingPosition, endingPosition, null);
    ...
    public void invalidMoveOpponent() throws ExecutionException, InterruptedException, TimeoutException {
        ...
        //try to move pawn
        Position startingPosition = (Position) TestFactory.getNewPosition(2, 5);
        Position endingPosition = (Position) TestFactory.getNewPosition(4, 5);
        ChessMove move = (ChessMove) TestFactory.getNewMove(startingPosition, endingPosition, null);
